...
#define __CONFIG_H
...
#elif defined TARGET_ALT_LINK
	#define LED1_CLOCK		0 //RCC_APB2ENR_IOPCEN
	...
	// dip switch connected to PA4/PA5
	#define USER_BTN

	#define USER_BTN_CLOCK	RCC_APB2ENR_IOPAEN
	#define USER_BTN_CFG	CLEAR_BIT(GPIOA->CRL, GPIO_CRL_CNF4_0 | GPIO_CRL_CNF5_0); \
							SET_BIT(GPIOA->CRL, GPIO_CRL_CNF4_1 | GPIO_CRL_CNF5_1); \
							CLEAR_BIT(GPIOA->ODR, GPIO_ODR_ODR4 | GPIO_ODR_ODR5) /* pull-down */
	#define USER_BTN_PRESS	(READ_BIT(GPIOA->IDR, GPIO_IDR_IDR4 | GPIO_IDR_IDR5) == GPIO_IDR_IDR5)
